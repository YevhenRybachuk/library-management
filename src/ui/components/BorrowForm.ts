...
export function createBorrowForm(
    ...
    const borrowLabel: HTMLLabelElement =
        document.createElement("label");

    borrowLabel.className = "form-label";
    borrowLabel.textContent = "Book to borrow";

    const borrowSelect: HTMLSelectElement =
        document.createElement("select");
    ...
    function renderOptions(): void {
        ...
        const selectedUser: User | undefined =
            userLibrary.find(userSelect.value);
        ...
        if (selectedUser !== undefined) {
            selectedUser.borrowedBookIds.forEach(
                (bookId: string): void => {
